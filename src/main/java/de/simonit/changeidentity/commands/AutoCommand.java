...
public abstract class AutoCommand<P extends JavaPlugin> extends Command {
	...
	static {
		...
		System.out.println("[ChangeIdentity] AutoCommand hook for Bukkit " + AutoCommand.VERSION + " by PostCrafter");
		System.out.println(
				"[ChangeIdentity] Visit his YouTube channel for very good german video tutorials: http://www.youtube.com/PostCrafter");
		System.out.println("[ChangeIdentity] Visit his german forum for help with Bukkit-plugins: http://postcrafter.de/");
	}
